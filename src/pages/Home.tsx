...
export default function Home({ onLogout }: HomeProps) {
  ...
  const [isDarkMode, setIsDarkMode] = useState(() => localStorage.getItem('toilet-map-theme') === 'dark');
    ...
    <div className="page">
      ...
      <div className="app-shell">
        ...
        <main>
          ...
          <section className="integrated-map-shell" aria-label="화장실 지도와 길찾기">
            <div className="map-home"><Map toilets={filtered} query={query} /></div>
          </section>
